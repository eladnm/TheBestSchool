...
class Student {
	...
	public function full_details() {
		if (isset($this->id) && isset($this->name) && isset($this->phone) && isset($this->email) && isset($this->image)) {
			return " id: " . $this->id . " name: " . $this->name . " phone: " . $this->phone . " email: " . $this->email . " image: " . $this->image;
		} else {
			return "";
		}
	}
